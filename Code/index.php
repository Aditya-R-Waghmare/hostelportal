...
<body style="background: url(img/hostel.jpg); background-size: cover;">
    ...
    <form action="login.php" method="post">
      ...
      <div class="qwe">
        <button class="btn btn-large btn-primary btn-block pull-right" href="dashboard.html" type="submit"><i
            class="icon-signin icon-large"></i>Login</button><br><br>
      </div>
  ...
  <footer>
    <div class="text-center" style="background-color: rgba(9, 55, 183, 0.8); ">
      <p class="copyright-agileinfo"> &copy; 2023 | Hostel Portal. | All Rights Reserved | Developed by team - Innovision</p>
    </div>
  </footer>
  </div>
