	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<a href="addstudents.php"><Button type="submit" class="btn btn-info"
						style="float:right; width:230px; height:35px;"><i class="icon-plus-sign icon-large"></i> Add
						Students</button></a><br><br>
					...
					<tbody>
						...
						for ($i = 0; $row = $result->fetch(); $i++) {
							...
							<td><a title="Click to view the Student"
									href="viewstudents.php?id=<?php echo $row['usn']; ?>"><button
										class="btn btn-success btn-mini"><i class="icon-search"></i> View</button>
								</a>
								<a title="Click to edit the Student Details"
									href="editstudents.php?id=<?php echo $row['usn']; ?>"><button
										class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit</button>
								</a>
								<a href="#" id="<?php echo $row['usn']; ?>" class="delbutton"
									title="Click To Delete this Student"><button class="btn btn-danger btn-mini"><i
